              ...
              <div className="rounded-lg w-full h-[200px] overflow-hidden carousel">
                ...
                >
                  <img
                    src={
                      dir +
                      "311590757_183171420896584_6251819352431627605_n.webp"
                    }
                    className="w-full"
                  />
                  <div className="top-1/2 right-5 left-5 absolute flex justify-between transform -translate-y-1/2">
                ...
                >
                  <img
                    src={
                      dir +
                      "310790237_498394945477101_1276484577073781258_n.webp"
                    }
                    className="w-full"
                  />
                  <div className="top-1/2 right-5 left-5 absolute flex justify-between transform -translate-y-1/2">
              ...
              <div className="rounded-lg w-full h-[200px] overflow-hidden carousel">
                ...
                >
                  <img
                    src={
                      dir +
                      "276106928_279979457493103_4748464840513651431_n.webp"
                    }
                    className="w-full"
                  />
                  <div className="top-1/2 right-5 left-5 absolute flex justify-between transform -translate-y-1/2">
                ...
                >
                  <img
                    src={
                      dir +
                      "276043595_522005912595397_3759447026620874580_n.webp"
                    }
                    className="w-full"
                  />
                  <div className="top-1/2 right-5 left-5 absolute flex justify-between transform -translate-y-1/2">
