              ...
              <div class="flex items-start sm:gap-8">
                ...
                <div>
                  ...
                  <p class="mt-1 text-justify text-sgray text-sm">
                    Whether you're an aspiring developer or a seasoned coder,
                    join us to unravel the secrets of this powerful JavaScript
                    library that empowers you to create seamless, modern, and
                    visually stunning websites. Get ready to transform your
                    coding skills into boundless possibilities – step into the
                    world of ReactJS and watch your web creations come to life!
                  </p>
