export default function Desc3() {
    return (
        <div className="px-4 py-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 dark:bg-gray-800 dark:text-gray-100">
            <h2 className="mb-8 text-2xl lg:text-4xl font-bold leading-none text-center">What do we have to offer?</h2>
